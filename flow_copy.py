...
MESSAGES = {
    ...
    "ideas_root": (
        ...
        "• 📦 Готовые решения — отвечаешь на пару вопросов, я собираю промпт.\n"
        "• 🧭 Подбор по шагам — что / стиль / формат, и готово."
    ),
    "ideas_templates_title": "📦 Выбери, что нужно сделать:",
    "ideas_qa_step": "Шаг {n}/{total}\n\n{q}",
    "ideas_type_hint": "✍️ Напиши ответ в чат (или «Пропустить», если не важно).",
    ...
    "invite_share_text": (
        "Лови бота, который рисует картинки и делает видео по тексту 🎨🎬 "
        "На старте — бесплатные кредиты!"
    ),
    "referral_reward_got": (
    ...
    "vid_upload_ask": (
        ...
        "Потом опишешь правку текстом. (Продление у загруженного видео недоступно.)"
    ),
    "vid_upload_working": "⬆️ Загружаю видео…",
    "vid_upload_failed": (
        "Не удалось загрузить видео. Кредиты не списаны — попробуй ещё раз "
        "или пришли файл поменьше."
    ),
    "vid_upload_need_video": "Здесь жду видео, а не этот файл. Пришли видеоролик.",
    "vid_upload_ask_prompt": (
        "Видео загружено! Опиши, что в нём изменить.\n"
