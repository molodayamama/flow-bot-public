...
MESSAGES = {
    "welcome": (
        "Привет! Я создаю картинки и видео по текстовому описанию — быстро и красиво.\n\n"
        "🎨 Опиши идею — получи картинку. Под результатом: изменить, варианты, "
        "заново, улучшить качество, оживить фото, скачать.\n"
        "🎬 Создавай видео из текста, из фото («Оживить фото») или своё видео.\n"
        "💡 Не знаешь, с чего начать? Кнопка «Идеи и шаблоны» подберёт готовый промпт.\n"
        "🤝 Приглашай друзей — получай кредиты за каждое их пополнение."
    ),
